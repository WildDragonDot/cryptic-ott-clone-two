...
(8, '862aedb5-3903-4ada-8d12-dda42b467d99', '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', '0ada9a87-8a5d-4702-b4bb-95e5aa37cb44', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36', 'Sun, 20 Nov 2022 09:41:35 +0530'),
(10, '3a7b6202-3b58-4567-b019-a5f7b2bcdc3a', '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', 'f6fc229b-03ec-4c2a-a411-3beca876cf55', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36', 'Sun, 20 Nov 2022 09:51:50 +0530'),
(13, 'e692fa26-ef03-4dd1-805d-94dcf069640a', '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', 'fed1667b-4d80-4083-b028-f4a0934608f8', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36', 'Sun, 20 Nov 2022 09:52:20 +0530');

-- --------------------------------------------------------

--
-- Table structure for table `favourite_webseries`
--

CREATE TABLE `favourite_webseries` (
  `favourite_webseries_id` int(20) NOT NULL,
  `favourite_webseries_uuid` varchar(200) NOT NULL,
  `user_id` varchar(200) NOT NULL,
  `webseries_info_id` varchar(200) NOT NULL,
  `from_ip` varchar(200) NOT NULL,
  `from_browser` varchar(200) NOT NULL,
  `from_time` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `favourite_webseries`
--

INSERT INTO `favourite_webseries` (`favourite_webseries_id`, `favourite_webseries_uuid`, `user_id`, `webseries_info_id`, `from_ip`, `from_browser`, `from_time`) VALUES
(2, 'cba81771-c821-4fae-bd52-46fb4ae95f8c', '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', 'fed1667b-4d80-4083-b028-f4a0934608f8', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36', 'Mon, 21 Nov 2022 08:26:14 +0530'),
(3, 'fc80228e-a8a3-443b-917e-1639ad130dc4', '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', 'addb9130-e382-4058-a885-af9ceab9f2c3', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36', 'Mon, 21 Nov 2022 08:27:17 +0530');
...
(35, '0x0729aaf5757658bdab03ce2b2d76c06089462ba0', NULL, '6392bb701e84b', '2022-10-26 08:28:54', '');
...
(1, 'addb9130-e382-4058-a885-af9ceab9f2c3', 'Money Heist', 'bafybeidla67ancc7vh3xhfw3376egbzz7d6z746mdki6howy3zmguq5upi', 'This is first episode', 'f9c5310f-f75f-4217-a0d9-af3891c40532', 'Web Series', 'super', '0xa2d9ded6115b7b7208459450d676f0127418ae7a:35330667205828808645805771972788148449949166894449166732923665699564597280771', 'Sat, 20 Aug 2022 06:49:13pm', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36', '::1'),
(2, 'fed1667b-4d80-4083-b028-f4a0934608f8', 'Dark', 'bafybeie2u52gs3f22xtphlfftltieycj6pnfjqmmk3y4mfsp4lwvxr6uje', 'This is an episode', 'f9c5310f-f75f-4217-a0d9-af3891c40532', 'Web Series', 'super', '0xa2d9ded6115b7b7208459450d676f0127418ae7a:35330667205828808645805771972788148449949166894449166732923665699564597280771', 'Sat, 25 Aug 2022 06:49:13pm', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36', '::1');
...
--
-- Indexes for table `favourite_webseries`
--
ALTER TABLE `favourite_webseries`
  ADD PRIMARY KEY (`favourite_webseries_id`);
...
--
-- AUTO_INCREMENT for table `favourite_webseries`
--
ALTER TABLE `favourite_webseries`
  MODIFY `favourite_webseries_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
